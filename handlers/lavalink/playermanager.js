...
async function search(client, message, args, type) {
    ...
    if (message.guild.me.permissionsIn(message.channel).has("EMBED_LINKS")) {
        ...
        results = new Discord.MessageEmbed()
            .setAuthor(message.author.username, message.author.displayAvatarURL({ dynamic: true }), "https://discord.gg/FKBwvZcrp8")
            .setColor(ee.color)
...
async function play(client, message, args, type) {
    ...
    function song_() {
        ...
        //otherwise
            ...
            //create info msg embed
            let playembed = new Discord.MessageEmbed()
                .setAuthor(`Added to queue`, message.author.displayAvatarURL({ dynamic: true }), "https://discord.gg/FKBwvZcrp8")
...
async function playskip(client, message, args, type) {
    ...
    function playlist_() {
        ...
        .setAuthor(`Playlist added to Queue`, message.author.displayAvatarURL({ dynamic: true }), "https://discord.gg/FKBwvZcrp8")
            .setColor(ee.color)
            .setTitle("**" + res.playlist.name + "**")
            .setThumbnail(`https://img.youtube.com/vi/${res.tracks[0].identifier}/mqdefault.jpg`)
            //timing for estimated time creation
