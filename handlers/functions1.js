  ...
  try {
    ...
    function reset(track_info_msg, queue_info_msg) {
      ...
      let embed3 = new MessageEmbed()
        ...
        .setDescription(`> Join a voice channel and enter a song name or url to play.\n\n[Invite KURUVI ](https://discord.com/api/oauth2/authorize?client_id=818042751068798986&permissions=8&scope=bot) • [Support Server](https://discord.gg/FKBwvZcrp8) • [Website](https://discord.gg/FKBwvZcrp8)`)
    ...
    function QueueEmbed(client, player) {
      ...
      const embed = new MessageEmbed().setAuthor(`Kuruvi Music | Music Queue`);
      const multiple = 15;
      const page = 1;
